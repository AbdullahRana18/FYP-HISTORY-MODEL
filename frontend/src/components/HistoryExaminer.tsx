...
import { Send, Brain, BookOpen, Award, ShieldCheck, Info, Sparkles, AlertTriangle } from 'lucide-react'
...
export default function HistoryExaminer() {
    ...
    return (
        <div className="h-screen bg-slate-950 flex flex-col md:flex-row overflow-hidden font-sans text-white">
